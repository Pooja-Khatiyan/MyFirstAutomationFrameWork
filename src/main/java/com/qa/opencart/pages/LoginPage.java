...
//PRIVATE Driver in public method : encapsulation 	
	...
	public AccountsPage doLogin(String username, String pwd) {
		...
		return new AccountsPage(driver);// is this is eligible of GC as have no reference?no becz we connected it
										// immediately with
		// in AccountPageTest with reference
		/**
		 * now page chaining model come into the picture,after click on login button we
		 * lending on the accounts page,if we click on something & we lend on new
		 * page,it's the method responsibility to return the next lending class object.
...
//it doesn't contain any assertion
	...
	public boolean doLoginWithWrongCredentials(String username, String pwd) {
		...
		log.info("wrong Creds are: " + username + ":" + pwd);
